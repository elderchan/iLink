...
├── lightme.soul.md               ← v1.8.0，可选设计/需求拷问命令
└── plugs/
...
| Gemini CLI | ✅ v1.8.0 首发（bootstrap 与 ilink-lightme.toml/.sh 已包含 plug 初始化） |
...
| `iLink/souls/lightme.soul.md` | SHOULD | Lightme 角色规范（可选设计/需求拷问命令，v1.8.0 新增；启用 `/ilink-lightme` 时 MUST） |
