#!/usr/bin/env bash
# iLink ilink-lightme — Gemini 平台脚本
# /ilink-lightme [-target pm|design] <story> 的预检
# 用法: bash .gemini/commands/ilink-lightme.sh [-target pm|design] <story-id>
...
# 定位项目根：脚本位于 <project_root>/.gemini/commands/ilink-lightme.sh
...
echo "  全新 Gemini CLI 会话更利于对抗 AI 自身合理性,但可能消耗更多 token;"
